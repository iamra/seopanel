...
<table width="400px" border="0" cellspacing="0" cellpadding="0" class="search">
	<tr>
		...
		<td><a href="javascript:void(0);" onclick="scriptDoLoadPost('saturationchecker.php', 'search_form', 'subcontent', '&sec=generate')"><img alt="" src="<?=SP_IMGPATH?>/proceed.gif"></a></td>		
	</tr>
</table>
</form>
