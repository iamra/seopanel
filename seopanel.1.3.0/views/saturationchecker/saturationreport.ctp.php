...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search">
	<tr>
		...
		<td colspan="2"><a href="javascript:void(0);" onclick="scriptDoLoadPost('saturationchecker.php', 'search_form', 'content', '&sec=reports')"><img alt="" src="<?=SP_IMGPATH?>/show_records.gif"></a></td>
	</tr>
</table>
</form>
