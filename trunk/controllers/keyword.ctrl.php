...
class KeywordController extends Controller{
	...
	function listKeywords($websiteId=''){		
		...
		$sql = "select k.*,w.name website,w.status webstatus from keywords k,websites w where k.website_id=w.id and w.user_id=$userId $conditions order by k.name";
	...
	function showKeywordSelectBox($userId='', $websiteId='', $keywordId=''){
		$this->set('keywordList', $this->__getAllKeywords($userId, $websiteId));
	...
	function __getAllKeywords($userId='', $websiteId=''){
